 ...
 * @LastEditors  : coconut
 * @LastEditTime : 2025-04-01 19:25:46
...
class HybridCoreXYKinematics : public Kinematics
{
public:
    HybridCoreXYKinematics(std::shared_ptr<ToolHead> toolhead,
        std::shared_ptr<ConfigWrapper> config);
    ~HybridCoreXYKinematics();
