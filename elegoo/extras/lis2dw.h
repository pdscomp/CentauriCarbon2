 ...
 * @LastEditors  : loping
 * @LastEditTime : 2025-08-07 15:25:16
...
namespace elegoo 
{
    namespace extras 
    {
        ...
        class Lis2dw : public std::enable_shared_from_this<Lis2dw>, public AccelChip
        {
        public:
            Lis2dw(std::shared_ptr<ConfigWrapper> config);
            ~Lis2dw();
        ...
        private:
            ...
            // uint32_t oid;
            std::shared_ptr<CommandWrapper> query_lis2dw_cmd;
