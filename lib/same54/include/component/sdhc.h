...
typedef union {
  struct {
    ...
    uint16_t get<int>EN:1;        /*!< bit:     14  Asynchronous Interrupt Enable      */
...
#define SDHC_HC2R_get<int>EN_Pos       14           /**< \brief (SDHC_HC2R) Asynchronous Interrupt Enable */
#define SDHC_HC2R_get<int>EN           (_U_(0x1) << SDHC_HC2R_get<int>EN_Pos)
#define   SDHC_HC2R_get<int>EN_DISABLED_Val  _U_(0x0)   /**< \brief (SDHC_HC2R) Disabled */
#define   SDHC_HC2R_get<int>EN_ENABLED_Val   _U_(0x1)   /**< \brief (SDHC_HC2R) Enabled */
#define SDHC_HC2R_get<int>EN_DISABLED  (SDHC_HC2R_get<int>EN_DISABLED_Val << SDHC_HC2R_get<int>EN_Pos)
#define SDHC_HC2R_get<int>EN_ENABLED   (SDHC_HC2R_get<int>EN_ENABLED_Val << SDHC_HC2R_get<int>EN_Pos)
...
typedef union {
  struct {
    ...
    uint32_t get<int>SUP:1;       /*!< bit:     29  Asynchronous Interrupt Support     */
...
#define SDHC_CA0R_get<int>SUP_Pos      29           /**< \brief (SDHC_CA0R) Asynchronous Interrupt Support */
#define SDHC_CA0R_get<int>SUP          (_U_(0x1) << SDHC_CA0R_get<int>SUP_Pos)
#define   SDHC_CA0R_get<int>SUP_NO_Val       _U_(0x0)   /**< \brief (SDHC_CA0R) Asynchronous Interrupt not Supported */
#define   SDHC_CA0R_get<int>SUP_YES_Val      _U_(0x1)   /**< \brief (SDHC_CA0R) Asynchronous Interrupt supported */
#define SDHC_CA0R_get<int>SUP_NO       (SDHC_CA0R_get<int>SUP_NO_Val     << SDHC_CA0R_get<int>SUP_Pos)
#define SDHC_CA0R_get<int>SUP_YES      (SDHC_CA0R_get<int>SUP_YES_Val    << SDHC_CA0R_get<int>SUP_Pos)
