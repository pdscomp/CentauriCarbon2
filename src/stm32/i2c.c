...
static const struct i2c_info i2c_bus[] = {
    #if !CONFIG_MACH_GD32F30x
    { (I2C_TypeDef *)I2C1, GPIO('B', 6), GPIO('B', 7) },
    { (I2C_TypeDef *)I2C1, GPIO('B', 8), GPIO('B', 9) },
    { (I2C_TypeDef *)I2C2, GPIO('B', 10), GPIO('B', 11) },
    #else
    { (I2C_TypeDef *)I2C0, GPIO('B', 6), GPIO('B', 7) },
    { (I2C_TypeDef *)I2C0, GPIO('B', 8), GPIO('B', 9) },
    { (I2C_TypeDef *)I2C1, GPIO('B', 10), GPIO('B', 11) },
    #endif
#if CONFIG_MACH_STM32F2 || CONFIG_MACH_STM32F4
